  ...
  return (
    <main style={page}>
      ...
      <section style={grid}>
        <div style={card}>
          ...
          <p style={text}>
            ...
            grupper, institutioner og virksomheder. Vi hjælper gerne med at finde
            det rigtige forløb.
          </p>
        ...
        <div style={card}>
          <h2 style={h2}>Typiske henvendelser</h2>
          <ul style={list}>
            <li style={listItem}>Hvilket kursus passer til mit niveau?</li>
            <li style={listItem}>Booking af oplevelser for grupper</li>
            <li style={listItem}>Spørgsmål om pris, varighed og indhold</li>
            <li style={listItem}>Praktiske spørgsmål om udstyr og deltagelse</li>
            <li style={listItem}>Skræddersyede forløb for skoler og virksomheder</li>
          </ul>
      ...
      <section style={ctaBand}>
        <h2 style={{ marginTop: 0, marginBottom: 14 }}>Vil du videre herfra?</h2>
        <p style={{ maxWidth: 720, margin: "0 auto 20px", lineHeight: 1.7 }}>
          Du kan gå direkte til booking eller udforske kurser og oplevelser, før du beslutter dig.
        </p>
