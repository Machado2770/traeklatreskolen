...
const instructors = [
  ...
  },
  {
    ...
    imagePosition: "center",
    bio: [
      "Kasper er uddannet træklatrevejleder og en del af teamet bag Træklatreskolen. Med en uddannelse som coach og mere end 20 års erfaring fra ledelse arbejder han i krydsfeltet mellem mennesker, ledelse og udvikling. Til daglig arbejder han med coaching og ledelsesudvikling, hvor naturen er rammen.",
  ...
  },
  {
    ...
    imagePosition: "center",
    bio: [
      "Martin Machado er natur- og friluftsvejleder, træklatrevejleder, censor i Dansk Træklatreforening og stifter af Træklatreskolen. Med en master i friluftsliv og mere end 20 års erfaring arbejder han i krydsfeltet mellem træklatring, naturdannelse, sikkerhed og fællesskab.",
