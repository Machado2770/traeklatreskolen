...
export const products = [
  ...
  {
    slug: "softshell-jakke-logo",
    name: "Softshell-jakke med Træklatreskolen-logo",
    short: "Smidig grøn softshell med hætte — Træklatreskolens logo i hvidt på brystet.",
    price: 1295,
    category: "Jakker & veste",
    image: "/images/shop/softshell-jakke-logo.jpg",
    description:
      "Smidig softshell-jakke i skovens farver med hætte og masser af lommer — vindtæt, åndbar og bevægelig nok til rebarbejde. Det er den type jakke, vi selv står i, når vejret driller i trækronerne. Leveres med Træklatreskolens logo trykt i hvidt på brystet. Fås i størrelse S–XXL — oplys størrelse ved bestilling (i bemærkningsfeltet ved fakturakøb, ellers kontakter vi dig inden afsendelse).",
    bullets: [
      "Vindtæt og åndbar softshell",
      "Hætte og rummelige lommer",
  ...
  },
  {
    ...
    description:
      "Vesten er klatrerens bedste ven: varm krop og helt frie arme til reb og karabiner. Sort vest med fleece i bunden og slidstærk front, leveret med Træklatreskolens logo trykt i hvidt på brystet. Fås i størrelse S–XXL — oplys størrelse ved bestilling (i bemærkningsfeltet ved fakturakøb, ellers kontakter vi dig inden afsendelse).",
    bullets: [
  ...
  {
    slug: "skaljakke-logo",
    name: "Skaljakke med Træklatreskolen-logo",
    short: "Vandtæt grøn skaljakke med hætte — til regnvejrsdage i kronerne.",
    price: 1495,
    category: "Jakker & veste",
    image: "/images/shop/skaljakke-logo.jpg",
    description:
      "Vandtæt skaljakke med tapede sømme, justerbar hætte og ventilationslynlåse — bygget til de dage, hvor undervisningen fortsætter, selvom regnen siler. Leveres med Træklatreskolens logo trykt i hvidt på brystet. Fås i størrelse S–XXL — oplys størrelse ved bestilling (i bemærkningsfeltet ved fakturakøb, ellers kontakter vi dig inden afsendelse).",
    bullets: [
