...
export const products = [
  ...
  // ── Jakker & veste ──────────────────────────────────────────────────────
  // Beklædning med Træklatreskolens logo i hvidt på brystet.
  // (Softshell- og skaljakken er internt arbejdstøj — se /admin/arbejdstoej.)
  {
    slug: "vest-logo",
    name: "Vest med Træklatreskolen-logo",
    short: "Sort fleece-/softshellvest — varm krop, frie arme og logo i hvidt.",
    price: 895,
    category: "Jakker & veste",
    sizes: ["S", "M", "L", "XL", "XXL"],
    image: "/images/shop/vest-logo.jpg",
    description:
      "Vesten er klatrerens bedste ven: varm krop og helt frie arme til reb og karabiner. Sort vest med fleece i bunden og slidstærk front, leveret med Træklatreskolens logo trykt i hvidt på brystet. Fås i størrelse S–XXL — vælg størrelse, når du lægger den i kurven.",
    bullets: [
      "Varm krop — frie arme til rebarbejde",
      "Fleece og slidstærk front",
      "Træklatreskolens logo i hvidt på brystet",
