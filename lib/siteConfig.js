...
// Sociale profiler. Linkes i footeren og i Organization.sameAs, så Google og
// AI-tjenester kan koble profilerne til virksomheden. URL'erne er offentlige,
// så de har faste defaults — env-variablen er kun til at overstyre med.
export const SOCIAL = {
  facebook:
    process.env.NEXT_PUBLIC_FACEBOOK_URL ||
    "https://www.facebook.com/profile.php?id=61591817278272",
  instagram:
    process.env.NEXT_PUBLIC_INSTAGRAM_URL ||
    "https://www.instagram.com/traeklatreskolen/",
